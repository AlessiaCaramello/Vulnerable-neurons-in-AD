...
# - markers_threshold.csv (metadata - threshold of positivity for each marker of interest)
# - vars_per_sample.csv (metadata - additional info of samples for analyses on subgroups)
