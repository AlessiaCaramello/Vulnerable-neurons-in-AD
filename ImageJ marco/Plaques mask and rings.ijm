...
xy_coord = SourceDir+"xy_coordinates"
File.makeDirectory(xy_coord);
print("XY coordinates files will be saved here:");
print(xy_coord);
print(" ");
		...
		run("Make Inverse");        
			...
			if (selectionType() != -1) {
				...
				run("Create Selection");
						...
						run("Save XY Coordinates...", "background=0", "invert", "suppress", "save=plaques_coord.txt");
