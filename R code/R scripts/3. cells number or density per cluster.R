...
countedl$TREM2var <- "CV"
countedl$ApoE4pos <- "E3/E3"
countedl$AD_stage <- "a"
countedl$TREM2var_ADstage <- "a"
countedl$ApoE4pos_TREM2 <- "a"
countedl$ApoE4pos_TREM2var <- "a"

# Add TREM2 variants
for (i in 1:nrow(countedl)){
  countedl$TREM2var[i] <- variants$TREM2var[grep(countedl$sample_name[i], variants$sample_name)]
  countedl$AD_stage[i] <- variants$AD_stage[grep(countedl$sample_name[i], variants$sample_name)]
  countedl$ApoE4pos[i] <- variants$ApoE4pos[grep(countedl$sample_name[i], variants$sample_name)]
  countedl$TREM2var_ADstage[i] <- variants$TREM2var_ADstage[grep(countedl$sample_name[i], variants$sample_name)]
  countedl$ApoE4pos_TREM2var[i] <- variants$ApoE4pos_TREM2var[grep(countedl$sample_name[i], variants$sample_name)]
}

# add columns for hosting variants
countedw$TREM2var <- "CV"
countedw$ApoE4pos <- "E3/E3"
countedw$AD_stage <- "a"
countedw$TREM2var_ADstage <- "a"
countedw$ApoE4pos_TREM2 <- "a"
countedw$ApoE4pos_TREM2var <- "a"

# Add TREM2 variants
for (i in 1:nrow(countedw)){
  countedw$TREM2var[i] <- variants$TREM2var[grep(countedw$sample_name[i], variants$sample_name)]
  countedw$AD_stage[i] <- variants$AD_stage[grep(countedw$sample_name[i], variants$sample_name)]
  countedw$ApoE4pos[i] <- variants$ApoE4pos[grep(countedw$sample_name[i], variants$sample_name)]
  countedw$TREM2var_ADstage[i] <- variants$TREM2var_ADstage[grep(countedw$sample_name[i], variants$sample_name)]
  countedw$ApoE4pos_TREM2var[i] <- variants$ApoE4pos_TREM2var[grep(countedw$sample_name[i], variants$sample_name)]
}

###### 2c. Define comparison and create folders (OPEN -->) ########
...
# 3rd slot = column with info of group names
...
###### 2d. Dirichlet and plot for loop for all comparisons defined ######
